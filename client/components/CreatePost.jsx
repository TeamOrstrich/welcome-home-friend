...
const CreatePost = () => {
  ...
  const inputDiv = (label, key, requiredBool) => {
    return (
  ...
  return (
    <div className='create-post'>
      ...
      <div className='create-post-inputs'>
        {inputDiv('Name:', 'name', true)}
        {/* {inputDiv('Breed:', 'type', true)} */}
        {inputDiv('Fur Color:', 'color')}
      ...
      <div className='cat-divider'>
        <img
          id='cat-divider'
          src='https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/de114712-7dca-4f5b-920a-8a7d7d75c452/de0jawd-5dcf5ace-2070-45d1-9511-9d6277d25180.gif?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..lDQR5USnXOaRH_Y0ijIykOzRbAO-9Zh3GlzdTvrY-Ms'
        />
      </div>
    </div>
  );
